package io.github.dryrum.processext

import org.codehaus.groovy.runtime.ProcessGroovyMethods
import java.io.File

fun String.runCommand(workingDir: File, outputList: MutableList<String>): List<String> {
    val error: AppendableErrorOutput =
        AppendableErrorOutputImpl(outputList)
...
private class AppendableErrorOutputImpl(val list: MutableList<String>) :
    AppendableErrorOutput {
